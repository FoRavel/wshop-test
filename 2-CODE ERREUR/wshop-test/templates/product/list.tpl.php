...
<body>
  ...
  <div class="container">
    ...
    <div class="row text-center">
        ...
        // Fix: Use __get() to obtain param
      		?>
      		<div class="col-lg-3 col-md-6 mb-4 bloc_product">
		        <div class="card h-100">
		          <img class="card-img-top" src="http://placehold.it/500x325" alt="">
		          <div class="card-body">
		            <h4 class="card-title"><?php echo $product->__get('produit_titreobjet'); // Titre objet ?></h4>
		            <p class="card-text"><?php echo $product->__get('produit_nom'); ?></p> 
		          </div>
